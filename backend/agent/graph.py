...
from agent.nodes import generate_pipeline_node, execute_query_node, formulate_response_node, generate_follow_ups_node
...
def build_graph():
    ...
    graph.add_edge("formulate_response", "generate_follow_ups")
